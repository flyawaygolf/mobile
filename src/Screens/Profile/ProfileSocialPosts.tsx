...
const ProfileSocialPosts = () => {
    ...
    const getPosts = async (load = false) => {
        ...
        const response = await client.posts.user.fetchSocialLinks(nickname, i18n.language, { pagination_key: postsPaginationKey });
        setLoading(false);
...
export default memo(ProfileSocialPosts);